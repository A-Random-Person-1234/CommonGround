...
- Google Calendar event sync is a per-user setting. Users who were already connected before this version should reconnect once so Google grants the event-write permission.
