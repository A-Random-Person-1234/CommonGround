...
try {
  ...
  assert.match(home.text, /href="\/styles\.css\?v=20260726-universal-time-picker"/);
  ...
  assert.ok(
    yesResponseIndex >= 0 && yesResponseIndex < noRespons…29299 tokens truncated…rows:\s*none[^}]*grid-auto-rows:\s*minmax\(214px, auto\)/s,
